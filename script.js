...
function displayBooks(bookArray = books) {
  ...
  bookArray.forEach((book) => { // 3. loop through books
    ...
    // 5. create individual elements for book details
    ...
    bookArticle.appendChild(bookGenre);
    bookArticle.appendChild(bookRating);
    bookArticle.appendChild(bookDescription);
    bookArticle.appendChild(bookImage);

    // 7. add the article to the page
